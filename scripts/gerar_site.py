...
function renderGlobalKpis(){{
  ...
  document.getElementById('global-kpis').innerHTML=`
    <div class="desemp-card" style="border-color:${{bordColor}};width:100%;justify-content:center">
      <div style="display:flex;align-items:center;gap:40px;flex-wrap:wrap;justify-content:center;width:100%">

        <!-- Bloco 1: Desempenho -->
        <div style="display:flex;flex-direction:column;align-items:center">
          <div class="desemp-label" style="text-align:center;margin-bottom:8px">Desempenho das Melhores Previsões</div>
          <div class="desemp-kpis" style="gap:24px">
        ...
        <!-- Bloco 3: Sem dados -->
        <div style="display:flex;flex-direction:column;align-items:center">
          <div class="desemp-label" style="text-align:center;margin-bottom:8px">⚠ Sem Dados</div>
          <div style="text-align:center">
            <div class="desemp-kpi-val" style="color:var(--yellow);font-size:22px">${{totalSd}}</div>
            <div class="desemp-kpi-lbl" style="margin-top:4px">sem confirmação</div>
          </div>
        </div>`:''}}
